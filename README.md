...
For your first presentation, you'll be presenting to a **non-technical** audience. You should prepare a slideshow with appropriately scaled visuals to complement a compelling narrative. **Presentation duration is 10-12 minutes per presenter.** Plan to leave a minute or two for questions from your peers!
...
[Tim Dwyer](https://www.linkedin.com/in/jtimdwyer/) (former DSI student and TA) put together [this style guide](https://git.generalassemb.ly/DSIR-823-Octopus/style-guide.git). Some recommendations are geared toward future projects (which will include modeling and span multiple notebooks), but generally these are great recommendations.
...
**Materials must be submitted on September 2 by 11:59 PM ET.**
...
**Please fork the project, download to your Submissions repo/folder, and submit a link in the [Google Classroom](https://classroom.google.com) assignment.**

---

### Presentation Structure

**You must be ready to present your findings by the start of class on September 2.**

- **Must be within time limit - not more than 12 minutes.**
...
### Rubric
Your instructors will evaluate your project using the following criteria.  You should make sure that you consider and/or follow all of the considerations/recommendations outlined below **while** working through your project.
